...
class RolePermissionController extends Controller
{
    ...
    private function groupPermissionsByCategory($permissions)
    {
        $categories = [
            ...
            'Drink Invoices' => ['view drink invoice', 'create drink invoices', 'edit drink invoices', 'delete drink invoices', 'add drink to invoice', 'remove drink from invoice', 'update drink invoice date', 'update drink invoice price', 'generate drink invoice'],
