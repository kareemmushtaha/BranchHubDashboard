...
@section('title', 'مشروبات الجلسات')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">مشروبات الجلسات</h1>
</div>
...
<div class="row mb-3">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('session-drinks.index') }}" class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('session-drinks.index') }}" class="btn btn-secondary">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($item->session)
                                        <a href="{{ route('sessions.show', $item->session) }}" class="text-decoration-none">
                                            #{{ $item->session->id }}
                                        </a>
                                    @else
                                        <span class="text-muted">غير متوفر</span>
                                ...
                                <td>
                                    @if($item->session && $item->session->user)
                                        <a href="{{ route('users.show', $item->session->user) }}" class="text-decoration-none">
                ...
                @else
                <p class="text-muted text-center">لا توجد مشروبات في هذا التاريخ</p>
                @endif
            </div>
        </div>
    </div>
